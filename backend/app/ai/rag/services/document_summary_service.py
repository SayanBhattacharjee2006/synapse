...
from app.ai.rag.embeddings import get_sparse_embeddings, get_dense_embeddings
...
async def store_document_summary(doc: Document,document_profile: DocumentProfile)-> None: 
    ...
    dense_vector, sparse_vector = await asyncio.gather(
        ...
        asyncio.to_thread(get_sparse_embeddings().embed_query, formatted_document_profile)
    )
