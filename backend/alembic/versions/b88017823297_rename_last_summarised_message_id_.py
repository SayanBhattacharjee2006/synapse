...
Revision ID: b88017823297
Revises: 3f6e599117bb
Create Date: 2026-06-01 14:18:46.455992
...
revision: str = 'b88017823297'
down_revision: Union[str, Sequence[str], None] = '3f6e599117bb'
...
def upgrade() -> None:
    ...
    op.add_column('conversations', sa.Column('lastSummarisedMessageId', sa.UUID(), nullable=True))
    op.drop_constraint(op.f('conversations_last_summarised_message_id_fkey'), 'conversations', type_='foreignkey')
    op.create_foreign_key(None, 'conversations', 'messages', ['lastSummarisedMessageId'], ['id'])
    op.drop_column('conversations', 'last_summarised_message_id')
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('conversations', sa.Column('last_summarised_message_id', sa.UUID(), autoincrement=False, nullable=True))
    op.drop_constraint(None, 'conversations', type_='foreignkey')
    op.create_foreign_key(op.f('conversations_last_summarised_message_id_fkey'), 'conversations', 'messages', ['last_summarised_message_id'], ['id'])
