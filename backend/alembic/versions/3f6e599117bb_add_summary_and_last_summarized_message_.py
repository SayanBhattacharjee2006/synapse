"""add summary and last_summarized_message_id to conversations

Revision ID: 3f6e599117bb
Revises: 0eebceb63fdd
Create Date: 2026-05-31 10:20:26.822290
...
revision: str = '3f6e599117bb'
down_revision: Union[str, Sequence[str], None] = '0eebceb63fdd'
...
def upgrade() -> None:
    ...
    op.add_column('conversations', sa.Column('last_summarised_message_id', sa.UUID(), nullable=True))
    op.create_foreign_key(None, 'conversations', 'messages', ['last_summarised_message_id'], ['id'])
