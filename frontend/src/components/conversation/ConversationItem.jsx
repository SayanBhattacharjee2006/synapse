...
export default function ConversationItem({
    ...
    return (
        <div
            ...
            className={`group flex min-h-[52px] w-full cursor-pointer items-center justify-between gap-3 rounded-xl border-l-2 px-4 py-3 transition-colors duration-200 ${
                isActive
                    ? "border-[var(--color-accent)] bg-[rgba(6,182,212,0.12)]"
        ...
        >
            ...
            <div className="hidden shrink-0 items-center gap-1.5 group-hover:flex group-focus-within:flex">
                <Button
                    variant="ghost"
                    size="icon"
                    onClick={(e) => {
